<?php
/**
 * Create/update the "Featured on 29News!" news post.
 * Run: wp eval-file wordpress-migration/create-29news-post.php
 */
...
$path = __DIR__ . '/news-export/post-featured-on-29news.json';
...
$thumb_id = 0;
if ($thumb_url !== '') {
	$basename = '29news-autism-sanctuary-feature.jpg';
	$found = get_posts([
...
if ($thumb_id) {
	...
	$alt = $data['thumb_alt'] ?? 'Autism Sanctuary participant with cattle in the pasture during 29News feature';
